...
1. Training materials: https://git-scm.com/doc/ext  ![click this pic](<00-media/Screenshot 2025-06-27 162143.png>)
## How to compare two commits?
[`How to compare any two commits?`](./02-articles/01-how-to-compare-any-two-commits/compare-any-two-commits.md)

[`How to push to empty repo?`](./02-articles/02-how-to-push-empty-repo/howto-push-empty-repo.md)

[`How to catch up with remote repo? and set a new branch?`]()

[`How to 'regrete'?`](./02-articles/03-regret-commit/regret.md)
